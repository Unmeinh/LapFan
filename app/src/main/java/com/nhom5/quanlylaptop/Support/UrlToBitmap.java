        ...
        if (bitmaps != null){
            ...
            if (bm1 != null) {
                Laptop lp1 = new Laptop("LP0", "LAsus", "Laptop Asus TUF Gaming FX506LHB i5 10300H"
                        , "RAM 8GB", "19.990.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm1)));
            ...
            if (bm2 != null) {
                Laptop lp2 = new Laptop("LP1", "LAsus", "Laptop Asus ROG Strix Gaming G513IH R7 4800H"
                        , "RAM 8GB", "21.190.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm2)));
            ...
            if (bm3 != null) {
                Laptop lp3 = new Laptop("LP2", "LMac", "Laptop Apple MacBook Pro 16 M1 Max 2021 10 core-CPU"
                        , "RAM 16GB", "85.990.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm3)));
            ...
            if (bm4 != null) {
                Laptop lp4 = new Laptop("LP3", "LMac", "Laptop Apple MacBook Pro M2 2022 8GB"
                        , "RAM 8GB", "35.990.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm4)));
            ...
            if (bm5 != null) {
                Laptop lp5 = new Laptop("LP4", "LHP", "Laptop HP 240 G8 i3 1005G1"
                        , "RAM 4GB", "13.790.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm5)));
            ...
            if (bm6 != null) {
                Laptop lp6 = new Laptop("LP5", "LHP", "Laptop HP Envy X360 13 bf0090TU i7 1250U"
                        , "RAM 16GB", "32.590.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm6)));
            ...
            if (bm7 != null) {
                Laptop lp7 = new Laptop("LP6", "LHP", "Laptop HP Pavilion X360 14 ek0055TU i7 1255U"
                        , "RAM 16GB", "25.590.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm7)));
            ...
            if (bm8 != null) {
                Laptop lp8 = new Laptop("LP7", "LAcer", "Laptop Acer TravelMate B3 TMB311 31 C2HB N4020"
                        , "RAM 4GB", "5.990.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm8)));
            ...
            if (bm9 != null) {
                Laptop lp9 = new Laptop("LP8", "LAcer", "Laptop Acer Nitro 5 Tiger AN515 58 773Y i7 12700H"
                        , "RAM 8GB", "31.990.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm9)));
            ...
            if (bm10 != null) {
                Laptop lp10 = new Laptop("LP9", "LDell", "Laptop Dell Gaming G15 5515 R5 5600H"
                        , "RAM 16GB", "23.490.000₫", changeType.checkByteInput(changeType.bitmapToByte(bm10)));
