    ...
    public void addDemoLaptopDell() {
        ...
        if (bm0 != null) {
            Laptop lp0 = new Laptop("0", "LDell", "Laptop Dell Gaming G15 5515 R5 5600H"
                    , "RAM 16GB", "23.490.000₫", 0, 2, changeType.checkByteInput(changeType.bitmapToByte(bm0)));
        ...
        if (bm1 != null) {
            Laptop lp1 = new Laptop("1", "LDell", "Laptop Dell Inspiron 15 3511 i3 1115G4"
                    , "RAM 4GB", "12.090.000₫", 3, 2, changeType.checkByteInput(changeType.bitmapToByte(bm1)));
        ...
        if (bm2 != null) {
            Laptop lp2 = new Laptop("2", "LDell", "Laptop Dell Gaming Alienware m15 R6 i7 11800H"
                    , "RAM 32GB", "61.640.000₫", 3, 2, changeType.checkByteInput(changeType.bitmapToByte(bm2)));
        ...
        if (bm0 != null) {
            Laptop lp3 = new Laptop("3", "LDell", "Laptop Dell Gaming G15 5511 i7 11800H"
                    , "RAM 8GB", "33.490.000₫", 2, 2, changeType.checkByteInput(changeType.bitmapToByte(bm3)));
        ...
        if (bm4 != null) {
            Laptop lp4 = new Laptop("4", "LDell", "Laptop Dell XPS 13 Plus 9320 i7 1260P"
                    , "RAM 16GB", "59.490.000₫", 1, 2, changeType.checkByteInput(changeType.bitmapToByte(bm4)));
    ...
    public void addDemoLaptopHP() {
        ...
        if (bm0 != null) {
            Laptop lp0 = new Laptop("5", "LHP", "Laptop HP VICTUS 16 d0292TX i5 11400H"
                    , "RAM 8GB", "26.590.000₫", 6, 2, changeType.checkByteInput(changeType.bitmapToByte(bm0)));
            laptopDAO.insertLaptop(lp0);
        }
        ...
        if (bm1 != null) {
            Laptop lp1 = new Laptop("6", "LHP", "Laptop HP Envy X360 13 bf0090TU i7 1250U"
                    , "RAM 16GB", "32.090.000₫", 2, 2, changeType.checkByteInput(changeType.bitmapToByte(bm1)));
            laptopDAO.insertLaptop(lp1);
        }
        ...
        if (bm2 != null) {
            Laptop lp2 = new Laptop("7", "LHP", "Laptop HP Envy x360 Convert 13 ay1056AU R7 5800U"
                    , "RAM 8GB", "25.890.000₫", 1, 2, changeType.checkByteInput(changeType.bitmapToByte(bm2)));
            laptopDAO.insertLaptop(lp2);
        }
        ...
        if (bm0 != null) {
            Laptop lp3 = new Laptop("8", "LHP", "Laptop HP Pavilion X360 14 ek0055TU i7 1255U"
                    , "RAM 16GB", "25.090.000₫", 3, 2, changeType.checkByteInput(changeType.bitmapToByte(bm3)));
            laptopDAO.insertLaptop(lp3);
        }
        ...
        if (bm4 != null) {
            Laptop lp4 = new Laptop("9", "LHP", "Laptop HP Pavilion X360 14 dy0171TU i3 1125G4"
                    , "RAM 4GB", "13.690.000₫", 6, 2, changeType.checkByteInput(changeType.bitmapToByte(bm4)));
            laptopDAO.insertLaptop(lp4);
        }
    }
    ...
    public void addDemoLaptopAcer() {
        ...
        if (bm0 != null) {
            Laptop lp0 = new Laptop("10", "LAcer", "Laptop Acer Swift X SFX16 51G 516Q i5 11320H"
                    , "RAM 16GB", "28.590.000₫", 4, 2, changeType.checkByteInput(changeType.bitmapToByte(bm0)));
            laptopDAO.insertLaptop(lp0);
        }
        ...
        if (bm1 != null) {
            Laptop lp1 = new Laptop("11", "LAcer", "Laptop Acer Nitro 5 Tiger AN515 58 773Y i7 12700H"
                    , "RAM 8GB", "31.490.000₫", 6, 2, changeType.checkByteInput(changeType.bitmapToByte(bm1)));
            laptopDAO.insertLaptop(lp1);
        }
        ...
        if (bm2 != null) {
            Laptop lp2 = new Laptop("12", "LAcer", "Laptop Acer Nitro 5 Gaming AN515 57 720A i7 11800H"
                    , "RAM 8GB", "28.490.000₫", 10, 2, changeType.checkByteInput(changeType.bitmapToByte(bm2)));
            laptopDAO.insertLaptop(lp2);
        }
        ...
        if (bm0 != null) {
            Laptop lp3 = new Laptop("13", "LAcer", "Laptop Acer Swift 3 SF314 511 55QE i5 1135G7"
                    , "RAM 16GB", "22.590.000₫", 10, 2, changeType.checkByteInput(changeType.bitmapToByte(bm3)));
            laptopDAO.insertLaptop(lp3);
        }
        ...
        if (bm4 != null) {
            Laptop lp4 = new Laptop("14", "LAcer", "Laptop Acer Aspire A315 57G 32QP i3 1005G1"
                    , "RAM 4GB", "13.190.000₫", 8, 2, changeType.checkByteInput(changeType.bitmapToByte(bm4)));
            laptopDAO.insertLaptop(lp4);
        }
    }
    ...
    public void addDemoLaptopAsus() {
        ...
        if (bm0 != null) {
            Laptop lp0 = new Laptop("15", "LAsus", "Laptop Asus TUF Gaming FX506LHB i5 10300H"
                    , "RAM 8GB", "18.790.000₫", 3, 2, changeType.checkByteInput(changeType.bitmapToByte(bm0)));
            laptopDAO.insertLaptop(lp0);
        }
        ...
        if (bm1 != null) {
            Laptop lp1 = new Laptop("16", "LAsus", "Laptop Asus Gaming ROG Flow Z13 GZ301Z i7 12700H"
                    , "RAM 16GB", "48.690.000₫", 2, 2, changeType.checkByteInput(changeType.bitmapToByte(bm1)));
            laptopDAO.insertLaptop(lp1);
        }
        ...
        if (bm2 != null) {
            Laptop lp2 = new Laptop("17", "LAsus", "Laptop Asus ROG Strix Gaming G513R R7 6800H"
                    , "RAM 8GB", "28.690.000₫", 5, 2, changeType.checkByteInput(changeType.bitmapToByte(bm2)));
            laptopDAO.insertLaptop(lp2);
        }
        ...
        if (bm0 != null) {
            Laptop lp3 = new Laptop("18", "LAsus", "Laptop Asus ZenBook UX425E i7 1165G7"
                    , "RAM 16GB", "27.190.000₫", 0, 2, changeType.checkByteInput(changeType.bitmapToByte(bm3)));
            laptopDAO.insertLaptop(lp3);
        }
        ...
        if (bm4 != null) {
            Laptop lp4 = new Laptop("19", "LAsus", "Asus ExpertBook B5402CB i5 1240P"
                    , "RAM 16GB", "26.990.000₫", 0, 2, changeType.checkByteInput(changeType.bitmapToByte(bm4)));
            laptopDAO.insertLaptop(lp4);
        }
    }
    ...
    public void addDemoLaptopMsi() {
        ...
        if (bm0 != null) {
            Laptop lp0 = new Laptop("20", "LMSi", "Laptop MSI Modern 14 B11SBU i5 1155G7"
                    , "RAM 8GB", "15.790.000₫", 2, 2, changeType.checkByteInput(changeType.bitmapToByte(bm0)));
            laptopDAO.insertLaptop(lp0);
        }
        ...
        if (bm1 != null) {
            Laptop lp1 = new Laptop("21", "LMSi", "Laptop MSI Gaming Bravo 15 B5DD R5 5600H"
                    , "RAM 8GB", "18.090.000₫", 3, 2, changeType.checkByteInput(changeType.bitmapToByte(bm1)));
            laptopDAO.insertLaptop(lp1);
        }
        ...
        if (bm2 != null) {
            Laptop lp2 = new Laptop("22", "LMSi", "Laptop MSI Gaming GE66 Raider 11UH i7 11800H"
                    , "RAM 32GB", "77.490.000₫", 5, 2, changeType.checkByteInput(changeType.bitmapToByte(bm2)));
            laptopDAO.insertLaptop(lp2);
        }
        ...
        if (bm0 != null) {
            Laptop lp3 = new Laptop("23", "LMSi", "Laptop MSI Gaming GE66 Raider 11UG i7 11800H"
                    , "RAM 16GB", "59.490.000₫", 6, 2, changeType.checkByteInput(changeType.bitmapToByte(bm3)));
            laptopDAO.insertLaptop(lp3);
        }
        ...
        if (bm4 != null) {
            Laptop lp4 = new Laptop("24", "LMSi", "Laptop MSI Creator Z16 A12UET i7 12700H"
                    , "RAM 16GB", "60.490.000₫", 5, 2, changeType.checkByteInput(changeType.bitmapToByte(bm4)));
            laptopDAO.insertLaptop(lp4);
        }
    }
    ...
    public void addDemoLaptopMac() {
        ...
        if (bm0 != null) {
            Laptop lp0 = new Laptop("25", "LMac", "Laptop Apple MacBook Air M2 2022 16GB"
                    , "RAM 16GB", "38.990.000₫", 3, 2, changeType.checkByteInput(changeType.bitmapToByte(bm0)));
            laptopDAO.insertLaptop(lp0);
        }
        ...
        if (bm1 != null) {
            Laptop lp1 = new Laptop("26", "LMac", "Laptop Apple MacBook Pro 16 M1 Pro 2021 10 core-CPU"
                    , "RAM 16GB", "66.990.000₫", 5, 2, changeType.checkByteInput(changeType.bitmapToByte(bm1)));
            laptopDAO.insertLaptop(lp1);
        }
        ...
        if (bm2 != null) {
            Laptop lp2 = new Laptop("27", "LMac", "Laptop Apple MacBook Pro 16 M1 Max 2021 10 core-CPU"
                    , "RAM 32GB", "92.990.000₫", 1, 2, changeType.checkByteInput(changeType.bitmapToByte(bm2)));
            laptopDAO.insertLaptop(lp2);
        }
        ...
        if (bm0 != null) {
            Laptop lp3 = new Laptop("28", "LMac", "Laptop Apple MacBook Pro M2 2022 8GB"
                    , "RAM 8GB", "35.990.000₫", 0, 2, changeType.checkByteInput(changeType.bitmapToByte(bm3)));
            laptopDAO.insertLaptop(lp3);
        }
        ...
        if (bm4 != null) {
            Laptop lp4 = new Laptop("29", "LMac", "Laptop Apple MacBook Air M1 2020 8GB"
                    , "RAM 8GB", "27.490.000₫", 3, 2, changeType.checkByteInput(changeType.bitmapToByte(bm4)));
            laptopDAO.insertLaptop(lp4);
        }
    }
}
